...
extension ModelContainer {
    ...
    static func inMemorySampleContainer() throws -> ModelContainer {
        ...
        let sampleItems: [PlanItem] = [
            PlanItem(title: "Morning run", date: today, daySection: .morning, isRecurring: true, recurringDays: [2, 3, 4, 5, 6]),
            PlanItem(title: "Coffee", date: today, daySection: .morning, isRecurring: true),
            PlanItem(title: "Team standup", date: today, deadline: cal.date(bySettingHour: 9, minute: 30, second: 0, of: today)),
            ...
            PlanItem(title: "Read", date: today, daySection: .evening, isRecurring: true),
        ]
