...
- Editing on today/future items with swipe gestures (cancel, defer, flag, delete); per-day share icon
- Initially land on *today* in the timeline view. And add a way to scroll to today as well.
