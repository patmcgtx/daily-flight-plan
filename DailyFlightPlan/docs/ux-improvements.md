...
Show selector view too

## Option to add calendar access later

In settings, if no access, add a link to add it

## Display time range on day section header

It leaves me feeling a little anxious, not knowing exactly what morning means or midday. Just show it.

## Automatically hide completed reminders
...
Let’s just always show them

## Hide past Calendar events

Basically treat them as completed items

## Import from Things, ideally

Use foundation models to auto-place

## A single short tap on an item brings up its edit screen

This way we can drop the info icon too.
...
It’s just a simple donut like it is for now. When you tap you get more details.
